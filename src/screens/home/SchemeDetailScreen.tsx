  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 16 }}>
      ...
      {scheme.status === 'needs_verification' && (
        <Card style={styles.warningCard}>
          <Text style={styles.warningText}>
            ⚠️ Some details for this scheme may be out of date. Please verify on the official link before applying.
          </Text>
        </Card>
      )}
      ...
      <Button
        ...
        variant="outline"
        onPress={() => navigation.navigate('SchemeQA', { schemeId: scheme.id, schemeTitle: scheme.title })}
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 15, fontWeight: '700', color: colors.primary, marginBottom: 6 },
  body: { fontSize: 14, color: colors.textPrimary, lineHeight: 20 },
  listItem: { fontSize: 14, color: colors.textPrimary, marginBottom: 4 },
  warningCard: { backgroundColor: '#FFF3E0', borderColor: colors.warning },
